...
class MineView {
    ...
    private class ControlPanel extends JPanel {
        ...
        ControlPanel() {
            ...
            JButton newGameButton1 = new JButton("MineSweeper");
            newGameButton1.addActionListener(new NewGameListener(true));
            newGameButton1.setMnemonic(KeyEvent.VK_N);
            add(newGameButton1);
            JButton newGameButton2 = new JButton("MineField");
            newGameButton2.addActionListener(new NewGameListener(false));
            newGameButton2.setMnemonic(KeyEvent.VK_N);
            add(newGameButton2);
            ...
            public void actionPerformed(ActionEvent event) {
                if (gametype == true) {
                    try {
                        ...
                        mineModel.newGame(numRows, numCols, numMines, gametype);
